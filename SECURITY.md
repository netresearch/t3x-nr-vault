...
- line and branch coverage overall and separately for `Classes/Crypto`,
  `Classes/Security`, `Classes/Audit` and `Classes/Http`, plus overall path
  coverage, measured over the unit and functional suites together,
